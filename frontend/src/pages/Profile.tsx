    ...
    <div className="w-full  flex justify-center items-center h">
        <div className="max-w-4xl max-auto flex-1 my-12 bg-white shadow-md rounded-2xl p-6">
            ...
            { !isAddressPresent && !isEditing ? (
                ...
                { !isEditing ?(
                    <div>
                        <h1 className="text-xl font-semibold text-center mb-3">Address Details</h1>
                        <div className=" grid grid-cols-2 gap-4 mb-4 text-gray-900">
                            <p className="bg-gray-100 rounded-2xl p-2"> <span className="font-semibold"> Address: </span>{addressData.address} </p>
                            <p className="bg-gray-100 rounded-2xl p-2"> <span className="font-semibold"> State: </span>{addressData.state} </p>
                            <p className="bg-gray-100 rounded-2xl p-2"> <span className="font-semibold"> District: </span>{addressData.district} </p>
                            <p className="bg-gray-100 rounded-2xl p-2"> <span className="font-semibold"> City: </span>{addressData.city} </p>
                            <p className="bg-gray-100 rounded-2xl p-2"> <span className="font-semibold"> Pincode: </span>{addressData.pincode} </p>
                            <p className="bg-gray-100 rounded-2xl p-2"> <span className="font-semibold"> Landmark: </span>{addressData.landmark} </p>
                        </div>
